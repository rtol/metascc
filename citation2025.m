...
ID{446} = {'Sreelekshmi (2025 RSMS)'};
s = {'IAWGSCC (2013)'};
d = {'Sreelekshmi (2025 RSMS)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'M. Sreelekshmi'},{'Dipnarayan Ganguly'});
A = addedge(A,{'M. Sreelekshmi'},{'Subbareddy Bonthu'});
A = addedge(A,{'M. Sreelekshmi'},{'R. Muruganandam'});
A = addedge(A,{'M. Sreelekshmi'},{'K.K. Manodheepan'});
A = addedge(A,{'M. Sreelekshmi'},{'M.H.K. Prasad'});
A = addedge(A,{'M. Sreelekshmi'},{'A. Paneer Selvam'});
A = addedge(A,{'M. Sreelekshmi'},{'R. Purvaja'});
A = addedge(A,{'Dipnarayan Ganguly'},{'Subbareddy Bonthu'});
A = addedge(A,{'Dipnarayan Ganguly'},{'R. Muruganandam'});
A = addedge(A,{'Dipnarayan Ganguly'},{'K.K. Manodheepan'});
A = addedge(A,{'Dipnarayan Ganguly'},{'M.H.K. Prasad'});
A = addedge(A,{'Dipnarayan Ganguly'},{'A. Paneer Selvam'});
A = addedge(A,{'Dipnarayan Ganguly'},{'R. Purvaja'});
A = addedge(A,{'Subbareddy Bonthu'},{'R. Muruganandam'});
A = addedge(A,{'Subbareddy Bonthu'},{'K.K. Manodheepan'});
A = addedge(A,{'Subbareddy Bonthu'},{'M.H.K. Prasad'});
A = addedge(A,{'Subbareddy Bonthu'},{'A. Paneer Selvam'});
A = addedge(A,{'Subbareddy Bonthu'},{'R. Purvaja'});
A = addedge(A,{'R. Muruganandam'},{'K.K. Manodheepan'});
A = addedge(A,{'R. Muruganandam'},{'M.H.K. Prasad'});
A = addedge(A,{'R. Muruganandam'},{'A. Paneer Selvam'});
A = addedge(A,{'R. Muruganandam'},{'R. Purvaja'});
A = addedge(A,{'K.K. Manodheepan'},{'M.H.K. Prasad'});
A = addedge(A,{'K.K. Manodheepan'},{'A. Paneer Selvam'});
A = addedge(A,{'K.K. Manodheepan'},{'R. Purvaja'});
A = addedge(A,{'M.H.K. Prasad'},{'A. Paneer Selvam'});
A = addedge(A,{'M.H.K. Prasad'},{'R. Purvaja'});
A = addedge(A,{'A. Paneer Selvam'},{'R. Purvaja'});

ID{447} = {'Estrada (2025 NComm)'};
s = {'Pearce (2003 OxREP)' 'Kalkuhl & Wenz (2020 JEEM)' 'IAWGSCC (2021)' 'Nordhaus (2010 PNAS)' 'Nordhaus (2017 PNAS)' 'Nordhaus (2019 PNAS)' 'Rennert (2022 Nature)' 'Ricke (2018 NCC)' 'Tol (2019 EnE)'};
d = {'Estrada (2025 NComm)' 'Estrada (2025 NComm)' 'Estrada (2025 NComm)' 'Estrada (2025 NComm)' 'Estrada (2025 NComm)' 'Estrada (2025 NComm)' 'Estrada (2025 NComm)' 'Estrada (2025 NComm)' 'Estrada (2025 NComm)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Francisco Estrada'},{'Richard S.J. Tol'});
A = addedge(A,{'Francisco Estrada'},{'W.J. Wouter Botzen'});
A = addedge(A,{'Francisco Estrada'},{'Veronica Lupi'});
A = addedge(A,{'Richard S.J. Tol'},{'W.J. Wouter Botzen'});
A = addedge(A,{'Richard S.J. Tol'},{'Veronica Lupi'});
A = addedge(A,{'W.J. Wouter Botzen'},{'Veronica Lupi'});

ID{448} = {'Rao (2025 CR)'};
s = {'Espagne (2018 IE)' 'Nordhaus (2013 YUP)' 'Nordhaus (2017 PNAS)' 'Nordhaus & Boyer (2000 MIT)' 'Nordhaus & Sztorc (2013 Yale)' 'Ploeg & Rezai (2019 EER)' 'Tol (2019 EnE)' 'Wong (2015 CTEP)' 'Al-Amin (2015 ESP)' 'Rasiah (2016 JCP)' 'Sarkar (2019 ESPR)' 'Wong (2016 CM)'};
d = {'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)' 'Rao (2025 CR)'  'Rao (2025 CR)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Thirupathi Rao'},{'Siti I. Mustapa'});
A = addedge(A,{'Thirupathi Rao'},{'Abdul Q. Al-Amin'});
A = addedge(A,{'Thirupathi Rao'},{'Adeel Ahmed'});
A = addedge(A,{'Siti I. Mustapa'},{'Abdul Q. Al-Amin'});
A = addedge(A,{'Siti I. Mustapa'},{'Adeel Ahmed'});
A = addedge(A,{'Abdul Q. Al-Amin'},{'Adeel Ahmed'});

ID{449} = {'Al-Amin (2015 ESP)'};
s = {'Stern (2006 CUP)' 'Heal & Millner (2014 PNAS)' 'Nordhaus (2001 Science)' 'Nordhaus (2007 JEL)' 'Nordhaus (2008 YUP)' 'Pizer (1999 REE)' 'Tol (2003 CC)'};
d = {'Al-Amin (2015 ESP)' 'Al-Amin (2015 ESP)' 'Al-Amin (2015 ESP)' 'Al-Amin (2015 ESP)' 'Al-Amin (2015 ESP)' 'Al-Amin (2015 ESP)' 'Al-Amin (2015 ESP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Abdul Q. Al-Amin'},{'Rajah Rasiah'});
A = addedge(A,{'Abdul Q. Al-Amin'},{['Santha Chenayah']});
A = addedge(A,{'Santha Chenayah'},{['Rajah Rasiah']});

ID{450} = {'Rasiah (2016 JCP)'};
s = {'Al-Amin (2015 ESP)' 'Nordhaus (2007 JEL)' 'Nordhaus (2008 YUP)' 'Stern (2006 CUP)'};
d = {'Rasiah (2016 JCP)' 'Rasiah (2016 JCP)' 'Rasiah (2016 JCP)' 'Rasiah (2016 JCP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Abdul Q. Al-Amin'},{'Walter Leal Filho'});
A = addedge(A,{'Abdul Q. Al-Amin'},{['Eduardo Calvo']});
A = addedge(A,{'Rajah Rasiah'},{'Walter Leal Filho'});
A = addedge(A,{'Rajah Rasiah'},{['Eduardo Calvo']});
A = addedge(A,{'Adeel Ahmed'},{'Walter Leal Filho'});
A = addedge(A,{'Adeel Ahmed'},{['Eduardo Calvo']});

ID{451} = {'Sarkar (2019 ESPR)'};
s = {'Fankhauser (1995 EarthScan)' 'Greenstone (2013 REEP)' 'IAWGSCC (2013)' 'Johnson & Hope (2012 JESS)' 'Nordhaus (2008 YUP)' 'Nordhaus (2017 PNAS)' 'Nordhaus (2014 JAERE)' 'Nordhaus (1991 EJ)' 'Nordhaus & Boyer (2000 MIT)' 'Nordhaus & Yang (1996 AER)' 'Rasiah (2016 JCP)' 'Ricke (2018 NCC)'  'Stern (2006 CUP)'};
d = {'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)' 'Sarkar (2019 ESPR)'  'Sarkar (2019 ESPR)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Abdul Q. Al-Amin'},{'M.S.K. Sarkar'});
A = addedge(A,{'Walter Leal Filho'},{['M.S.K. Sarkar']});

ID{452} = {'Wong (2016 CM)'};
s = {'Roughgarden & Schneider (1999 EnP)' 'Clarkson & Deyes (2002 HMT)' 'IAWGSCC (2010)' 'IAWGSCC (2013)' 'Anthoff & Tol (2010 JEEM)' 'Nordhaus (2011 NBER)' 'Hope (2011 Judge)' 'Hope (2011 Ejrn)' 'Hope (2006 IAJ)' 'Nordhaus (1991 EJ)' 'Watkiss (2005 DEFRA)' 'Hope & Hope (2013 NCC)' 'Ackerman & Stanton (2012 Ejrn)' 'Nordhaus (2008 YUP)' 'Stern (2006 CUP)' 'Tol (2010 CUP)' 'Wong (2015 CTEP)'};
d = {'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)' 'Wong (2016 CM)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{453} = {'Kerns (2025 ES)'};
s = {'Rennert (2022 Nature)'};
d = {'Kerns (2025 ES)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Kylor Kerns'},{'Mark White'});
A = addedge(A,{'Kylor Kerns'},{'Mariana Camacho'});
A = addedge(A,{'Kylor Kerns'},{'Karen McGlathery'});
A = addedge(A,{'Kylor Kerns'},{'Chris Patrick'});
A = addedge(A,{'Mark White'},{'Mariana Camacho'});
A = addedge(A,{'Mark White'},{'Karen McGlathery'});
A = addedge(A,{'Mark White'},{'Chris Patrick'});
A = addedge(A,{'Mariana Camacho'},{'Karen McGlathery'});
A = addedge(A,{'Mariana Camacho'},{'Chris Patrick'});
A = addedge(A,{'Karen McGlathery'},{'Chris Patrick'});

ID{454} = {'Cheu & Gammans (2025 AEPP)'};
s = {'EPA (2023)'};
d = {'Cheu & Gammans (2025 AEPP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Sungmin Cheu'},{'Matthew Gammans'});

ID{455} = {'Bhattacharya (2025 NComm)'};
s = {'Nordhaus (2017 PNAS)' 'Rennert (2022 Nature)' 'IAWGSCC (2015)'};
d = {'Bhattacharya (2025 NComm)' 'Bhattacharya (2025 NComm)' 'Bhattacharya (2025 NComm)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Ashmita Bhattacharya'},{'Konstantinos G. Papakonstantinou'});
A = addedge(A,{'Ashmita Bhattacharya'},{'Gordon P. Warn'});
A = addedge(A,{'Ashmita Bhattacharya'},{'Lauren McPhillips'});
A = addedge(A,{'Ashmita Bhattacharya'},{'Melissa M. Bilec'});
A = addedge(A,{'Ashmita Bhattacharya'},{'Chris E. Forest'});
A = addedge(A,{'Ashmita Bhattacharya'},{'Rafah Hasan'});
A = addedge(A,{'Ashmita Bhattacharya'},{'Digant Chavda'});
A = addedge(A,{'Konstantinos G. Papakonstantinou'},{'Gordon P. Warn'});
A = addedge(A,{'Konstantinos G. Papakonstantinou'},{'Lauren McPhillips'});
A = addedge(A,{'Konstantinos G. Papakonstantinou'},{'Melissa M. Bilec'});
A = addedge(A,{'Konstantinos G. Papakonstantinou'},{'Chris E. Forest'});
A = addedge(A,{'Konstantinos G. Papakonstantinou'},{'Rafah Hasan'});
A = addedge(A,{'Konstantinos G. Papakonstantinou'},{'Digant Chavda'});
A = addedge(A,{'Gordon P. Warn'},{'Lauren McPhillips'});
A = addedge(A,{'Gordon P. Warn'},{'Melissa M. Bilec'});
A = addedge(A,{'Gordon P. Warn'},{'Chris E. Forest'});
A = addedge(A,{'Gordon P. Warn'},{'Rafah Hasan'});
A = addedge(A,{'Gordon P. Warn'},{'Digant Chavda'});
A = addedge(A,{'Lauren McPhillips'},{'Melissa M. Bilec'});
A = addedge(A,{'Lauren McPhillips'},{'Chris E. Forest'});
A = addedge(A,{'Lauren McPhillips'},{'Rafah Hasan'});
A = addedge(A,{'Lauren McPhillips'},{'Digant Chavda'});
A = addedge(A,{'Melissa M. Bilec'},{'Chris E. Forest'});
A = addedge(A,{'Melissa M. Bilec'},{'Rafah Hasan'});
A = addedge(A,{'Melissa M. Bilec'},{'Digant Chavda'});
A = addedge(A,{'Chris E. Forest'},{'Rafah Hasan'});
A = addedge(A,{'Chris E. Forest'},{'Digant Chavda'});
A = addedge(A,{'Rafah Hasan'},{'Digant Chavda'});

ID{456} = {'Naef (2025 CEE)'};
s = {'Nordhaus (1993 REE)' 'Nordhaus (2017 PNAS)' 'Nordhaus (2019 AER)' 'Rennert (2022 Nature)'};
d = {'Naef (2025 CEE)' 'Naef (2025 CEE)' 'Naef (2025 CEE)' 'Naef (2025 CEE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Alain Naef'},{'Nina L. Friggens'});
A = addedge(A,{'Alain Naef'},{'Patrick Njeukam'});
A = addedge(A,{'Nina L. Friggens'},{'Patrick Njeukam'});

ID{457} = {'Akdag (2025 JOES)'};
s = {'Eteriki (2023 ieCRES)'};
d = {'Akdag (2025 JOES)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addnode(A,{'Ozan Akdag'});

ID{458} = {'Eteriki (2023 ieCRES)'};
A = addedge(A,{'Mohammad A. Eteriki'},{'Wedad A. El-Osta'});
A = addedge(A,{'Mohammad A. Eteriki'},{'Yasser F. Nassar'});
A = addedge(A,{'Mohammad A. Eteriki'},{'Hala E. El-Khozondar'});
A = addedge(A,{'Wedad A. El-Osta'},{'Yasser F. Nassar'});
A = addedge(A,{'Wedad A. El-Osta'},{'Hala E. El-Khozondar'});
A = addedge(A,{'Yasser F. Nassar'},{'Hala E. El-Khozondar'});

ID{459} = {'Arab (2025 DC)'};
s = {'Bijgaart (2016 JEEM)'};
d = {'Arab (2025 DC)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Berlant Arab'},{'Mohamed A. Raouf'});
A = addedge(A,{'Berlant Arab'},{'Amir Rahal'});
A = addedge(A,{'Berlant Arab'},{'Mariam Mostafa'});
A = addedge(A,{'Berlant Arab'},{'Mohamed N. AbouZeid'});
A = addedge(A,{'Mohamed A. Raouf'},{'Amir Rahal'});
A = addedge(A,{'Mohamed A. Raouf'},{'Mariam Mostafa'});
A = addedge(A,{'Mohamed A. Raouf'},{'Mohamed N. AbouZeid'});
A = addedge(A,{'Amir Rahal'},{'Mariam Mostafa'});
A = addedge(A,{'Amir Rahal'},{'Mohamed N. AbouZeid'});
A = addedge(A,{'Mariam Mostafa'},{'Mohamed N. AbouZeid'});

ID{460} = {'Wu (2025 CBM)'};
s = {'Rennert (2022 Nature)'};
d = {'Wu (2025 CBM)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Brent Sohngen'},{'Yining Wu'});
A = addedge(A,{'Brent Sohngen'},{'Eric C. Davis'});
A = addedge(A,{'Yining Wu'},{'Eric C. Davis'});

ID{461} = {'Bhave (2024 DSJ)'};
H = addnode(H,'Bhave (2024 DSJ)');
A = addedge(A,{'Prashant P. Bhave'},{'Chetan Dhawad'});
A = addedge(A,{'Prashant P. Bhave'},{'Vibha Jain'});
A = addedge(A,{'Chetan Dhawad'},{'Vibha Jain'});

ID{462} = {'Aleshina (2024 SCED)'};
s = {'Barrage & Nordhaus (2023 NBER)' 'Hansel (2020 NCC)' 'Nordhaus (1993 REE)' 'Nordhaus (2017 PNAS)' 'Nordhaus (2018 AEJ)' 'Nordhaus & Yang (1996 AER)' 'Yang (2018 GEC)'};
d = {'Aleshina (2024 SCED)' 'Aleshina (2024 SCED)' 'Aleshina (2024 SCED)' 'Aleshina (2024 SCED)' 'Aleshina (2024 SCED)' 'Aleshina (2024 SCED)' 'Aleshina (2024 SCED)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Sofia Aleshina'},{'Laura Delgado-Antequera'});
A = addedge(A,{'Sofia Aleshina'},{'German Gemar'});
A = addedge(A,{'Laura Delgado-Antequera'},{'German Gemar'});

ID{463} = {'Piazza (2025 EnE)'};
s = {'Ricke (2018 NCC)'};
d = {'Piazza (2025 EnE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Lucia Piazza'},{'Francesco P. Colelli'});
A = addedge(A,{'Lucia Piazza'},{'Wilmer Pasut'});
A = addedge(A,{'Lucia Piazza'},{'Enrica de Cian'});
A = addedge(A,{'Francesco P. Colelli'},{'Wilmer Pasut'});
A = addedge(A,{'Francesco P. Colelli'},{'Enrica de Cian'});
A = addedge(A,{'Wilmer Pasut'},{'Enrica de Cian'});

ID{464} = {'Eduardo (2025 Sust)'};
s = {'EPA (2023)'};
d = {'Eduardo (2025 Sust)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Santiago Eduardo'},{'Katharina M. Schmitz'});
A = addedge(A,{'Santiago Eduardo'},{'Erik A. Recklies'});
A = addedge(A,{'Santiago Eduardo'},{'Semih Severengiz'});
A = addedge(A,{'Katharina M. Schmitz'},{'Erik A. Recklies'});
A = addedge(A,{'Katharina M. Schmitz'},{'Semih Severengiz'});
A = addedge(A,{'Erik A. Recklies'},{'Semih Severengiz'});

ID{465} = {'Zhu (2025 AEn)'};
s = {'Rennert (2022 Nature)'};
d = {'Zhu (2025 AEn)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Yanlei Zhu'},{'Ming Ren'});
A = addedge(A,{'Yanlei Zhu'},{'Jingyang Song'});
A = addedge(A,{'Yanlei Zhu'},{'Teng Ma'});
A = addedge(A,{'Yanlei Zhu'},{'Yihan Wang'});
A = addedge(A,{'Yanlei Zhu'},{'Chen Huang'});
A = addedge(A,{'Yanlei Zhu'},{'Zhi Cao'});
A = addedge(A,{'Yanlei Zhu'},{'Hancheng Dai'});
A = addedge(A,{'Ming Ren'},{'Jingyang Song'});
A = addedge(A,{'Ming Ren'},{'Teng Ma'});
A = addedge(A,{'Ming Ren'},{'Yihan Wang'});
A = addedge(A,{'Ming Ren'},{'Chen Huang'});
A = addedge(A,{'Ming Ren'},{'Zhi Cao'});
A = addedge(A,{'Ming Ren'},{'Hancheng Dai'});
A = addedge(A,{'Jingyang Song'},{'Teng Ma'});
A = addedge(A,{'Jingyang Song'},{'Yihan Wang'});
A = addedge(A,{'Jingyang Song'},{'Chen Huang'});
A = addedge(A,{'Jingyang Song'},{'Zhi Cao'});
A = addedge(A,{'Jingyang Song'},{'Hancheng Dai'});
A = addedge(A,{'Teng Ma'},{'Yihan Wang'});
A = addedge(A,{'Teng Ma'},{'Chen Huang'});
A = addedge(A,{'Teng Ma'},{'Zhi Cao'});
A = addedge(A,{'Teng Ma'},{'Hancheng Dai'});
A = addedge(A,{'Yihan Wang'},{'Chen Huang'});
A = addedge(A,{'Yihan Wang'},{'Zhi Cao'});
A = addedge(A,{'Yihan Wang'},{'Hancheng Dai'});
A = addedge(A,{'Chen Huang'},{'Zhi Cao'});
A = addedge(A,{'Chen Huang'},{'Hancheng Dai'});
A = addedge(A,{'Zhi Cao'},{'Hancheng Dai'});

ID{466} = {'Xuan (2025 En)'};
s = {'Rennert (2022 Nature)' 'Tol (2019 EnE)' 'IAWGSCC (2015)'};
d = {'Xuan (2025 En)' 'Xuan (2025 En)' 'Xuan (2025 En)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Tao Xuan'},{'Xusheng Cheng'});
A = addedge(A,{'Tao Xuan'},{'Liwei Wang'});
A = addedge(A,{'Xusheng Cheng'},{'Liwei Wang'});

ID{467} = {'Wu (2025 EEE)'};
s = {'Ricke (2018 NCC)'};
d = {'Wu (2025 EEE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Xinyi Wu'},{'Ningyu Yan'});
A = addedge(A,{'Xinyi Wu'},{'Zengkai Zhang'});
A = addedge(A,{'Ningyu Yan'},{'Zengkai Zhang'});

ID{468} = {'Chen (2025 JEM)'};
s = {'Barrage & Nordhaus (2023 NBER)' 'Nordhaus (2017 PNAS)' 'Rennert (2022 Nature)' 'Wang (2022 One Earth)'};
d = {'Chen (2025 JEM)' 'Chen (2025 JEM)' 'Chen (2025 JEM)' 'Chen (2025 JEM)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Junjie Chen'},{'Xin Lai'});
A = addedge(A,{'Junjie Chen'},{'Quanwei Chen'});
A = addedge(A,{'Junjie Chen'},{'Yuejiu Zheng'});
A = addedge(A,{'Junjie Chen'},{'Yue Niu'});
A = addedge(A,{'Junjie Chen'},{'Lin Sun'});
A = addedge(A,{'Junjie Chen'},{'Bo Tang'});
A = addedge(A,{'Junjie Chen'},{'E Cheng'});
A = addedge(A,{'Xin Lai'},{'Quanwei Chen'});
A = addedge(A,{'Xin Lai'},{'Yuejiu Zheng'});
A = addedge(A,{'Xin Lai'},{'Yue Niu'});
A = addedge(A,{'Xin Lai'},{'Lin Sun'});
A = addedge(A,{'Xin Lai'},{'Bo Tang'});
A = addedge(A,{'Xin Lai'},{'E Cheng'});
A = addedge(A,{'Quanwei Chen'},{'Yuejiu Zheng'});
A = addedge(A,{'Quanwei Chen'},{'Yue Niu'});
A = addedge(A,{'Quanwei Chen'},{'Lin Sun'});
A = addedge(A,{'Quanwei Chen'},{'Bo Tang'});
A = addedge(A,{'Quanwei Chen'},{'E Cheng'});
A = addedge(A,{'Yuejiu Zheng'},{'Yue Niu'});
A = addedge(A,{'Yuejiu Zheng'},{'Lin Sun'});
A = addedge(A,{'Yuejiu Zheng'},{'Bo Tang'});
A = addedge(A,{'Yuejiu Zheng'},{'E Cheng'});
A = addedge(A,{'Yue Niu'},{'Lin Sun'});
A = addedge(A,{'Yue Niu'},{'Bo Tang'});
A = addedge(A,{'Yue Niu'},{'E Cheng'});
A = addedge(A,{'Lin Sun'},{'Bo Tang'});
A = addedge(A,{'Lin Sun'},{'E Cheng'});
A = addedge(A,{'Bo Tang'},{'E Cheng'});

ID{469} = {'Aksoy & Arli (2025 JEM)'};
s = {'Barrage & Nordhaus (2023 NBER)' 'Bretschger & Pattakou (2019 ERE)' 'Dennig (2015 PNAS)' 'IAWGSCC (2021)' 'Moore & Diaz (2015 NCC)' 'Nordhaus (1992 Science)' 'Pindyck (2019 JEEM)' 'Popp (2004 JEEM)' 'Rennert (2022 Nature)' 'Rennert (2021 BPEA)' 'Ricke (2018 NCC)' 'Tol (2019 EnE)' 'Traeger (2014 ERE)'};
d = {'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)' 'Aksoy & Arli (2025 JEM)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Fadime Aksoy'},{'Nuran B. Arli'});

ID{470} = {'Zhou (2025 JCP)'};
s = {'Barrage (2020 REStud)' 'Nordhaus (2017 PNAS)' 'Nordhaus (2018 AEJ)'};
d = {'Zhou (2025 JCP)' 'Zhou (2025 JCP)' 'Zhou (2025 JCP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addnode(A,{'Zhou Feng'});

ID{471} = {'Lima (2025 ED)'};
s = {'Rennert (2022 Nature)' 'Ricke (2018 NCC)'};
d = {'Lima (2025 ED)' 'Lima (2025 ED)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Marcos T.D. Lima'},{'Milton M. Fernandes'});
A = addedge(A,{'Marcos T.D. Lima'},{'Junior R. Garcia'});
A = addedge(A,{'Marcos T.D. Lima'},{'Luis O.B. Macedo'});
A = addedge(A,{'Milton M. Fernandes'},{'Junior R. Garcia'});
A = addedge(A,{'Milton M. Fernandes'},{'Luis O.B. Macedo'});
A = addedge(A,{'Junior R. Garcia'},{'Luis O.B. Macedo'});

ID{472} = {'Wu (2025 FPE)'};
s = {'Bressler (2021 NComm)' 'Nordhaus (2017 PNAS)' 'Rennert (2022 Nature)'};
d = {'Wu (2025 FPE)' 'Wu (2025 FPE)' 'Wu (2025 FPE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addnode(A,{'Jianxian Wu'});

ID{473} = {'Ashenfarb (2025 ERE)'};
s = {'Adler (2017 NCC)' 'Anthoff & Emmerling (2019 JAERE)' 'Anthoff (2009 EcE)' 'Azar & Sterner (1996 EcE)' 'Kikstra (2021 ERL)' 'Kotchen (2018 JAERE)' 'Nordhaus (2007 JEL)' 'Nordhaus (2017 PNAS)' 'Pindyck (2019 JEEM)'  'Rennert (2022 Nature)' 'Stern (2006 CUP)' 'Tol (2019 EnE)' 'EPA (2023)' 'Waldhoff (2014 Ejrn)'};
d = {'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)' 'Ashenfarb (2025 ERE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Matthew J. Kotchen'},{'Matthew Ashenfarb'});

ID{474} = {'Xu (2025 Land)'};
s = {'Tian (2019 JCP)'};
d = {'Xu (2025 Land)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Kuiyuan Xu'},{'Ruhan Li'});
A = addedge(A,{'Kuiyuan Xu'},{'Mengnan Liu'});
A = addedge(A,{'Kuiyuan Xu'},{'Yajie Cao'});
A = addedge(A,{'Kuiyuan Xu'},{'Jinwen Yang'});
A = addedge(A,{'Kuiyuan Xu'},{'Yali Wei'});
A = addedge(A,{'Ruhan Li'},{'Mengnan Liu'});
A = addedge(A,{'Ruhan Li'},{'Yajie Cao'});
A = addedge(A,{'Ruhan Li'},{'Jinwen Yang'});
A = addedge(A,{'Ruhan Li'},{'Yali Wei'});
A = addedge(A,{'Mengnan Liu'},{'Yajie Cao'});
A = addedge(A,{'Mengnan Liu'},{'Jinwen Yang'});
A = addedge(A,{'Mengnan Liu'},{'Yali Wei'});
A = addedge(A,{'Yajie Cao'},{'Jinwen Yang'});
A = addedge(A,{'Yajie Cao'},{'Yali Wei'});
A = addedge(A,{'Jinwen Yang'},{'Yali Wei'});

ID{475} = {'Chen (2025 Energy)'};
s = {'Nordhaus (2017 PNAS)' 'Barrage & Nordhaus (2024 PNAS)'};
d = {'Chen (2025 Energy)' 'Chen (2025 Energy)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Fubin Chen'},{'Zhao Yang'});
A = addedge(A,{'Fubin Chen'},{'Yiping Wang'});
A = addedge(A,{'Fubin Chen'},{'Hongxia He'});
A = addedge(A,{'Fubin Chen'},{'Yong Zhang'});
A = addedge(A,{'Fubin Chen'},{'Yanfeng Zhao'});
A = addedge(A,{'Zhao Yang'},{'Yiping Wang'});
A = addedge(A,{'Zhao Yang'},{'Hongxia He'});
A = addedge(A,{'Zhao Yang'},{'Yong Zhang'});
A = addedge(A,{'Zhao Yang'},{'Yanfeng Zhao'});
A = addedge(A,{'Yiping Wang'},{'Hongxia He'});
A = addedge(A,{'Yiping Wang'},{'Yong Zhang'});
A = addedge(A,{'Yiping Wang'},{'Yanfeng Zhao'});
A = addedge(A,{'Hongxia He'},{'Yong Zhang'});
A = addedge(A,{'Hongxia He'},{'Yanfeng Zhao'});
A = addedge(A,{'Yong Zhang'},{'Yanfeng Zhao'});

ID{476} = {'Behzadi & Arani (2025 IJF)'};
H = addnode(H,{'Behzadi & Arani (2025 IJF)'});
A = addedge(A,{'Abbas Behzadi'},{'Ali A.A. Arani'});

ID{477} = {'Pranita & Sarjana (2025 Energies)'};
s = {'Stern (2006 CUP)' 'EPA (2023)'};
d = {'Pranita & Sarjana (2025 Energies)' 'Pranita & Sarjana (2025 Energies)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Diaz Pranita'},{'Sri Sarjana'});

ID{478} = {'Li & Pizer (2021 JEEM)'};
s = {'Gerlagh & Liski (2018 JEEA)' 'Golosov (2014 Ectra)' 'IAWGSCC (2010)' 'IAWGSCC (2015)'};
d = {'Li & Pizer (2021 JEEM)' 'Li & Pizer (2021 JEEM)' 'Li & Pizer (2021 JEEM)' 'Li & Pizer (2021 JEEM)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Qingran Li'},{'William A. Pizer'});

ID{479} = {'Khan (2025 ESI)'};
s = {'Barrage & Nordhaus (2024 PNAS)'};
d = {'Khan (2025 ESI)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Waseem R. Khan'},{'Michele Giani'});
A = addedge(A,{'Waseem R. Khan'},{'Stanislao Bevilacqua'});
A = addedge(A,{'Waseem R. Khan'},{'Shoaib A. Anees'});
A = addedge(A,{'Waseem R. Khan'},{'Kaleem Mehmood'});
A = addedge(A,{'Waseem R. Khan'},{'M. Nazre'});
A = addedge(A,{'Waseem R. Khan'},{'Abdul A.B.A. Haddy'});
A = addedge(A,{'Waseem R. Khan'},{'Abang N.B.A. Median'});
A = addedge(A,{'Waseem R. Khan'},{'Japanie B. Bujang'});
A = addedge(A,{'Waseem R. Khan'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Waseem R. Khan'},{'Johar Mohamed'});
A = addedge(A,{'Waseem R. Khan'},{'Zaiton Samdin'});
A = addedge(A,{'Waseem R. Khan'},{'Rambod Abiri'});
A = addedge(A,{'Waseem R. Khan'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Waseem R. Khan'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Waseem R. Khan'},{'Hamid-Reza Naji'});
A = addedge(A,{'Waseem R. Khan'},{'Seemab Akram'});
A = addedge(A,{'Waseem R. Khan'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Waseem R. Khan'},{'Timothy Dube'});
A = addedge(A,{'Michele Giani'},{'Stanislao Bevilacqua'});
A = addedge(A,{'Michele Giani'},{'Shoaib A. Anees'});
A = addedge(A,{'Michele Giani'},{'Kaleem Mehmood'});
A = addedge(A,{'Michele Giani'},{'M. Nazre'});
A = addedge(A,{'Michele Giani'},{'Abdul A.B.A. Haddy'});
A = addedge(A,{'Michele Giani'},{'Abang N.B.A. Median'});
A = addedge(A,{'Michele Giani'},{'Japanie B. Bujang'});
A = addedge(A,{'Michele Giani'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Michele Giani'},{'Johar Mohamed'});
A = addedge(A,{'Michele Giani'},{'Zaiton Samdin'});
A = addedge(A,{'Michele Giani'},{'Rambod Abiri'});
A = addedge(A,{'Michele Giani'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Michele Giani'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Michele Giani'},{'Hamid-Reza Naji'});
A = addedge(A,{'Michele Giani'},{'Seemab Akram'});
A = addedge(A,{'Michele Giani'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Michele Giani'},{'Timothy Dube'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Shoaib A. Anees'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Kaleem Mehmood'});
A = addedge(A,{'Stanislao Bevilacqua'},{'M. Nazre'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Abdul A.B.A. Haddy'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Abang N.B.A. Median'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Japanie B. Bujang'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Johar Mohamed'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Zaiton Samdin'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Rambod Abiri'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Hamid-Reza Naji'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Seemab Akram'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Stanislao Bevilacqua'},{'Timothy Dube'});
A = addedge(A,{'Shoaib A. Anees'},{'Kaleem Mehmood'});
A = addedge(A,{'Shoaib A. Anees'},{'M. Nazre'});
A = addedge(A,{'Shoaib A. Anees'},{'Abdul A.B.A. Haddy'});
A = addedge(A,{'Shoaib A. Anees'},{'Abang N.B.A. Median'});
A = addedge(A,{'Shoaib A. Anees'},{'Japanie B. Bujang'});
A = addedge(A,{'Shoaib A. Anees'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Shoaib A. Anees'},{'Johar Mohamed'});
A = addedge(A,{'Shoaib A. Anees'},{'Zaiton Samdin'});
A = addedge(A,{'Shoaib A. Anees'},{'Rambod Abiri'});
A = addedge(A,{'Shoaib A. Anees'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Shoaib A. Anees'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Shoaib A. Anees'},{'Hamid-Reza Naji'});
A = addedge(A,{'Shoaib A. Anees'},{'Seemab Akram'});
A = addedge(A,{'Shoaib A. Anees'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Shoaib A. Anees'},{'Timothy Dube'});
A = addedge(A,{'Kaleem Mehmood'},{'M. Nazre'});
A = addedge(A,{'Kaleem Mehmood'},{'Abdul A.B.A. Haddy'});
A = addedge(A,{'Kaleem Mehmood'},{'Abang N.B.A. Median'});
A = addedge(A,{'Kaleem Mehmood'},{'Japanie B. Bujang'});
A = addedge(A,{'Kaleem Mehmood'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Kaleem Mehmood'},{'Johar Mohamed'});
A = addedge(A,{'Kaleem Mehmood'},{'Zaiton Samdin'});
A = addedge(A,{'Kaleem Mehmood'},{'Rambod Abiri'});
A = addedge(A,{'Kaleem Mehmood'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Kaleem Mehmood'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Kaleem Mehmood'},{'Hamid-Reza Naji'});
A = addedge(A,{'Kaleem Mehmood'},{'Seemab Akram'});
A = addedge(A,{'Kaleem Mehmood'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Kaleem Mehmood'},{'Timothy Dube'});
A = addedge(A,{'M. Nazre'},{'Abdul A.B.A. Haddy'});
A = addedge(A,{'M. Nazre'},{'Abang N.B.A. Median'});
A = addedge(A,{'M. Nazre'},{'Japanie B. Bujang'});
A = addedge(A,{'M. Nazre'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'M. Nazre'},{'Johar Mohamed'});
A = addedge(A,{'M. Nazre'},{'Zaiton Samdin'});
A = addedge(A,{'M. Nazre'},{'Rambod Abiri'});
A = addedge(A,{'M. Nazre'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'M. Nazre'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'M. Nazre'},{'Hamid-Reza Naji'});
A = addedge(A,{'M. Nazre'},{'Seemab Akram'});
A = addedge(A,{'M. Nazre'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'M. Nazre'},{'Timothy Dube'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Abang N.B.A. Median'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Japanie B. Bujang'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Johar Mohamed'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Zaiton Samdin'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Rambod Abiri'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Hamid-Reza Naji'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Seemab Akram'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Abdul A.B.A. Haddy'},{'Timothy Dube'});
A = addedge(A,{'Abang N.B.A. Median'},{'Japanie B. Bujang'});
A = addedge(A,{'Abang N.B.A. Median'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Abang N.B.A. Median'},{'Johar Mohamed'});
A = addedge(A,{'Abang N.B.A. Median'},{'Zaiton Samdin'});
A = addedge(A,{'Abang N.B.A. Median'},{'Rambod Abiri'});
A = addedge(A,{'Abang N.B.A. Median'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Abang N.B.A. Median'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Abang N.B.A. Median'},{'Hamid-Reza Naji'});
A = addedge(A,{'Abang N.B.A. Median'},{'Seemab Akram'});
A = addedge(A,{'Abang N.B.A. Median'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Abang N.B.A. Median'},{'Timothy Dube'});
A = addedge(A,{'Japanie B. Bujang'},{'Fatin-N. Mohamad-I.'});
A = addedge(A,{'Japanie B. Bujang'},{'Johar Mohamed'});
A = addedge(A,{'Japanie B. Bujang'},{'Zaiton Samdin'});
A = addedge(A,{'Japanie B. Bujang'},{'Rambod Abiri'});
A = addedge(A,{'Japanie B. Bujang'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Japanie B. Bujang'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Japanie B. Bujang'},{'Hamid-Reza Naji'});
A = addedge(A,{'Japanie B. Bujang'},{'Seemab Akram'});
A = addedge(A,{'Japanie B. Bujang'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Japanie B. Bujang'},{'Timothy Dube'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Johar Mohamed'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Zaiton Samdin'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Rambod Abiri'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Hamid-Reza Naji'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Seemab Akram'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Fatin-N. Mohamad-I.'},{'Timothy Dube'});
A = addedge(A,{'Johar Mohamed'},{'Zaiton Samdin'});
A = addedge(A,{'Johar Mohamed'},{'Rambod Abiri'});
A = addedge(A,{'Johar Mohamed'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Johar Mohamed'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Johar Mohamed'},{'Hamid-Reza Naji'});
A = addedge(A,{'Johar Mohamed'},{'Seemab Akram'});
A = addedge(A,{'Johar Mohamed'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Johar Mohamed'},{'Timothy Dube'});
A = addedge(A,{'Zaiton Samdin'},{'Rambod Abiri'});
A = addedge(A,{'Zaiton Samdin'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Zaiton Samdin'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Zaiton Samdin'},{'Hamid-Reza Naji'});
A = addedge(A,{'Zaiton Samdin'},{'Seemab Akram'});
A = addedge(A,{'Zaiton Samdin'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Zaiton Samdin'},{'Timothy Dube'});
A = addedge(A,{'Rambod Abiri'},{'Tuan-M. Tuan-I.'});
A = addedge(A,{'Rambod Abiri'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Rambod Abiri'},{'Hamid-Reza Naji'});
A = addedge(A,{'Rambod Abiri'},{'Seemab Akram'});
A = addedge(A,{'Rambod Abiri'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Rambod Abiri'},{'Timothy Dube'});
A = addedge(A,{'Tuan-M. Tuan-I.'},{'Lydia-S. Mohamad-I.'});
A = addedge(A,{'Tuan-M. Tuan-I.'},{'Hamid-Reza Naji'});
A = addedge(A,{'Tuan-M. Tuan-I.'},{'Seemab Akram'});
A = addedge(A,{'Tuan-M. Tuan-I.'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Tuan-M. Tuan-I.'},{'Timothy Dube'});
A = addedge(A,{'Lydia-S. Mohamad-I.'},{'Hamid-Reza Naji'});
A = addedge(A,{'Lydia-S. Mohamad-I.'},{'Seemab Akram'});
A = addedge(A,{'Lydia-S. Mohamad-I.'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Lydia-S. Mohamad-I.'},{'Timothy Dube'});
A = addedge(A,{'Hamid-Reza Naji'},{'Seemab Akram'});
A = addedge(A,{'Hamid-Reza Naji'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Hamid-Reza Naji'},{'Timothy Dube'});
A = addedge(A,{'Seemab Akram'},{'Hazandy Abdul-Hamid'});
A = addedge(A,{'Seemab Akram'},{'Timothy Dube'});
A = addedge(A,{'Hazandy Abdul-Hamid'},{'Timothy Dube'});

ID{480} = {'Zhang (2025 Forests)'};
s = {'IAWGSCC (2021)' 'Rennert & Kingdon (2019 RFF)'};
d = {'Zhang (2025 Forests)' 'Zhang (2025 Forests)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Xufang Zhang'},{'Pooja Chhetri'});
A = addedge(A,{'Xufang Zhang'},{'Aaron Stottlemyer'});
A = addedge(A,{'Xufang Zhang'},{'Ford O Brien'});
A = addedge(A,{'Xufang Zhang'},{'Eric McConnell'});
A = addedge(A,{'Pooja Chhetri'},{'Aaron Stottlemyer'});
A = addedge(A,{'Pooja Chhetri'},{'Ford O Brien'});
A = addedge(A,{'Pooja Chhetri'},{'Eric McConnell'});
A = addedge(A,{'Aaron Stottlemyer'},{'Ford O Brien'});
A = addedge(A,{'Aaron Stottlemyer'},{'Eric McConnell'});
A = addedge(A,{'Ford O Brien'},{'Eric McConnell'});

ID{481} = {'Yu (2025 WR)'};
s = {'Marten & Newbold (2012 EnP)' 'Nordhaus (2014 JAERE)'};
d = {'Yu (2025 WR)' 'Yu (2025 WR)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Wei Yu'},{'Fali Liu'});
A = addedge(A,{'Wei Yu'},{'Xianglan Jiao'});
A = addedge(A,{'Wei Yu'},{'Pingping Fan'});
A = addedge(A,{'Wei Yu'},{'Haiquan Yang'});
A = addedge(A,{'Wei Yu'},{'Yongmei Zhang'});
A = addedge(A,{'Wei Yu'},{'Jie Li'});
A = addedge(A,{'Wei Yu'},{'Jingan Chen'});
A = addedge(A,{'Wei Yu'},{'Xuede Li'});
A = addedge(A,{'Fali Liu'},{'Xianglan Jiao'});
A = addedge(A,{'Fali Liu'},{'Pingping Fan'});
A = addedge(A,{'Fali Liu'},{'Haiquan Yang'});
A = addedge(A,{'Fali Liu'},{'Yongmei Zhang'});
A = addedge(A,{'Fali Liu'},{'Jie Li'});
A = addedge(A,{'Fali Liu'},{'Jingan Chen'});
A = addedge(A,{'Fali Liu'},{'Xuede Li'});
A = addedge(A,{'Xianglan Jiao'},{'Pingping Fan'});
A = addedge(A,{'Xianglan Jiao'},{'Haiquan Yang'});
A = addedge(A,{'Xianglan Jiao'},{'Yongmei Zhang'});
A = addedge(A,{'Xianglan Jiao'},{'Jie Li'});
A = addedge(A,{'Xianglan Jiao'},{'Jingan Chen'});
A = addedge(A,{'Xianglan Jiao'},{'Xuede Li'});
A = addedge(A,{'Pingping Fan'},{'Haiquan Yang'});
A = addedge(A,{'Pingping Fan'},{'Yongmei Zhang'});
A = addedge(A,{'Pingping Fan'},{'Jie Li'});
A = addedge(A,{'Pingping Fan'},{'Jingan Chen'});
A = addedge(A,{'Pingping Fan'},{'Xuede Li'});
A = addedge(A,{'Haiquan Yang'},{'Yongmei Zhang'});
A = addedge(A,{'Haiquan Yang'},{'Jie Li'});
A = addedge(A,{'Haiquan Yang'},{'Jingan Chen'});
A = addedge(A,{'Haiquan Yang'},{'Xuede Li'});
A = addedge(A,{'Yongmei Zhang'},{'Jie Li'});
A = addedge(A,{'Yongmei Zhang'},{'Jingan Chen'});
A = addedge(A,{'Yongmei Zhang'},{'Xuede Li'});
A = addedge(A,{'Jie Li'},{'Jingan Chen'});
A = addedge(A,{'Jie Li'},{'Xuede Li'});
A = addedge(A,{'Jingan Chen'},{'Xuede Li'});

ID{482} = {'Brooks (2025 Science)'};
s = {'Rennert & Kingdon (2019 RFF)' 'Rennert (2022 Nature)'};
d = {'Brooks (2025 Science)' 'Brooks (2025 Science)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Nina Brooks'},{'Debashish Biswas'});
A = addedge(A,{'Nina Brooks'},{'Sameer Maithel'});
A = addedge(A,{'Nina Brooks'},{'Grant Miller'});
A = addedge(A,{'Nina Brooks'},{'Aprajit Mahajan'});
A = addedge(A,{'Nina Brooks'},{'M. Rofi Uddin'});
A = addedge(A,{'Nina Brooks'},{'Shoeb Ahmed'});
A = addedge(A,{'Nina Brooks'},{'Moogdho Mahzab'});
A = addedge(A,{'Nina Brooks'},{'Mahbubur Rahman'});
A = addedge(A,{'Nina Brooks'},{'Stephen P. Luby'});
A = addedge(A,{'Debashish Biswas'},{'Sameer Maithel'});
A = addedge(A,{'Debashish Biswas'},{'Grant Miller'});
A = addedge(A,{'Debashish Biswas'},{'Aprajit Mahajan'});
A = addedge(A,{'Debashish Biswas'},{'M. Rofi Uddin'});
A = addedge(A,{'Debashish Biswas'},{'Shoeb Ahmed'});
A = addedge(A,{'Debashish Biswas'},{'Moogdho Mahzab'});
A = addedge(A,{'Debashish Biswas'},{'Mahbubur Rahman'});
A = addedge(A,{'Debashish Biswas'},{'Stephen P. Luby'});
A = addedge(A,{'Sameer Maithel'},{'Grant Miller'});
A = addedge(A,{'Sameer Maithel'},{'Aprajit Mahajan'});
A = addedge(A,{'Sameer Maithel'},{'M. Rofi Uddin'});
A = addedge(A,{'Sameer Maithel'},{'Shoeb Ahmed'});
A = addedge(A,{'Sameer Maithel'},{'Moogdho Mahzab'});
A = addedge(A,{'Sameer Maithel'},{'Mahbubur Rahman'});
A = addedge(A,{'Sameer Maithel'},{'Stephen P. Luby'});
A = addedge(A,{'Grant Miller'},{'Aprajit Mahajan'});
A = addedge(A,{'Grant Miller'},{'M. Rofi Uddin'});
A = addedge(A,{'Grant Miller'},{'Shoeb Ahmed'});
A = addedge(A,{'Grant Miller'},{'Moogdho Mahzab'});
A = addedge(A,{'Grant Miller'},{'Mahbubur Rahman'});
A = addedge(A,{'Grant Miller'},{'Stephen P. Luby'});
A = addedge(A,{'Aprajit Mahajan'},{'M. Rofi Uddin'});
A = addedge(A,{'Aprajit Mahajan'},{'Shoeb Ahmed'});
A = addedge(A,{'Aprajit Mahajan'},{'Moogdho Mahzab'});
A = addedge(A,{'Aprajit Mahajan'},{'Mahbubur Rahman'});
A = addedge(A,{'Aprajit Mahajan'},{'Stephen P. Luby'});
A = addedge(A,{'M. Rofi Uddin'},{'Shoeb Ahmed'});
A = addedge(A,{'M. Rofi Uddin'},{'Moogdho Mahzab'});
A = addedge(A,{'M. Rofi Uddin'},{'Mahbubur Rahman'});
A = addedge(A,{'M. Rofi Uddin'},{'Stephen P. Luby'});
A = addedge(A,{'Shoeb Ahmed'},{'Moogdho Mahzab'});
A = addedge(A,{'Shoeb Ahmed'},{'Mahbubur Rahman'});
A = addedge(A,{'Shoeb Ahmed'},{'Stephen P. Luby'});
A = addedge(A,{'Moogdho Mahzab'},{'Mahbubur Rahman'});
A = addedge(A,{'Moogdho Mahzab'},{'Stephen P. Luby'});
A = addedge(A,{'Mahbubur Rahman'},{'Stephen P. Luby'});

ID{483} = {'Castellini (2025 EnE)'};
s = {'Adler (2017 NCC)' 'Budolfson (2017 CC)' 'Dennig (2015 PNAS)' 'Golosov (2014 Ectra)' 'Howard & Sterner (2017 ERE)' 'Kalkuhl & Wenz (2020 JEEM)' 'Moore (2017 NComm)' 'Nordhaus (2009 Yale)' 'Nordhaus (2010 PNAS)' 'Nordhaus (2011 NBER)' 'Nordhaus (2014 JAERE)' 'Nordhaus (2018 AEJ)' 'Nordhaus & Boyer (2000 MIT)' 'Nordhaus & Sztorc (2013 Yale)' 'Nordhaus & Yang (1996 AER)' 'Rennert (2022 Nature)' 'Wijst (2023 NCC)'};
d = {'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)' 'Castellini (2025 EnE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Marta Castellini'},{'Chiara Castelli'});
A = addedge(A,{'Marta Castellini'},{'Camilla Gusperti'});
A = addedge(A,{'Marta Castellini'},{'Veronica Lupi'});
A = addedge(A,{'Marta Castellini'},{'Sergio Vergalli'});
A = addedge(A,{'Chiara Castelli'},{'Camilla Gusperti'});
A = addedge(A,{'Chiara Castelli'},{'Veronica Lupi'});
A = addedge(A,{'Chiara Castelli'},{'Sergio Vergalli'});
A = addedge(A,{'Camilla Gusperti'},{'Veronica Lupi'});
A = addedge(A,{'Camilla Gusperti'},{'Sergio Vergalli'});
A = addedge(A,{'Veronica Lupi'},{'Sergio Vergalli'});

ID{484} = {'Estrada (2025 ANYAS)'};
s = {'Nordhaus (2013 YUP)' 'Nordhaus & Boyer (2000 MIT)' 'Wijst (2023 NCC)' 'Cai & Lontzek (2019 JPE)' 'Bremer & Ploeg (2021 AER)' 'Nordhaus (2010 PNAS)' 'Nordhaus (2018 AEJ)' 'Nordhaus (2017 PNAS)' 'Fankhauser (1995 EarthScan)' 'Ricke (2018 NCC)' 'IAWGSCC (2021)' 'Rennert (2022 Nature)' 'Bressler (2021 NComm)' 'Bilal & Kanzig (2024 NBER)'};
d = {'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)' 'Estrada (2025 ANYAS)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{485} = {'Landry (2025 EnE)'};
s = {'Stern (2006 CUP)' 'Nordhaus & Boyer (2000 MIT)' 'Nordhaus & Yang (1996 AER)' 'Nordhaus (2015 AER)' 'Nordhaus (2017 PNAS)' 'Kotchen (2018 JAERE)' 'IAWGSCC (2010)' 'Landry (2021 JPubE)'}; 
d = {'Landry (2025 EnE)' 'Landry (2025 EnE)' 'Landry (2025 EnE)' 'Landry (2025 EnE)' 'Landry (2025 EnE)' 'Landry (2025 EnE)' 'Landry (2025 EnE)' 'Landry (2025 EnE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addnode(A,{'Joel R. Landry'});

ID{486} = {'Landry (2021 JPubE)'};
s = {'Stern (2006 CUP)' 'Nordhaus (2015 AER)' 'Nordhaus (2019 AER)' 'IAWGSCC (2010)'}; 
d = {'Landry (2021 JPubE)' 'Landry (2021 JPubE)' 'Landry (2021 JPubE)' 'Landry (2021 JPubE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{487} = {'Garcia (2025 FR)'};
s = {'Anthoff (2011 Ejrn)' 'Rennert (2022 Nature)'};
d = {'Garcia (2025 FR)' 'Garcia (2025 FR)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Dorleta Garcia'},{'Marga Andres'});
A = addedge(A,{'Dorleta Garcia'},{'Iosu Paradinas'});
A = addedge(A,{'Dorleta Garcia'},{'Paula Alvarez'});
A = addedge(A,{'Dorleta Garcia'},{'Guillermo Boyra'});
A = addedge(A,{'Dorleta Garcia'},{'Rolf A. Groeneveld'});
A = addedge(A,{'Marga Andres'},{'Iosu Paradinas'});
A = addedge(A,{'Marga Andres'},{'Paula Alvarez'});
A = addedge(A,{'Marga Andres'},{'Guillermo Boyra'});
A = addedge(A,{'Marga Andres'},{'Rolf A. Groeneveld'});
A = addedge(A,{'Iosu Paradinas'},{'Paula Alvarez'});
A = addedge(A,{'Iosu Paradinas'},{'Guillermo Boyra'});
A = addedge(A,{'Iosu Paradinas'},{'Rolf A. Groeneveld'});
A = addedge(A,{'Paula Alvarez'},{'Guillermo Boyra'});
A = addedge(A,{'Paula Alvarez'},{'Rolf A. Groeneveld'});
A = addedge(A,{'Guillermo Boyra'},{'Rolf A. Groeneveld'});

ID{488} = {'Deng (2025 CC)'};
s = {'Barrage (2020 REStud)' 'Cai & Lontzek (2019 JPE)' 'Gerlagh & Liski (2018 JEEA)' 'Golosov (2014 Ectra)' 'Hwang (2017 REE)' 'Jensen & Traeger (2014 EER)' 'Nordhaus (2010 PNAS)' 'Rezai & Ploeg (2016 JAERE)' 'Bremer & Ploeg (2021 AER)' 'Deng (2024 EAP)'};
d = {'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)' 'Deng (2025 CC)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Huai Deng'},{'Huan Wu'});
A = addedge(A,{'Huai Deng'},{'Hui Xu'});
A = addedge(A,{'Huan Wu'},{'Hui Xu'});

ID{489} = {'Deng (2024 EAP)'};
s = {'Barrage (2020 REStud)' 'Cai & Lontzek (2019 JPE)' 'Golosov (2014 Ectra)' 'Jensen & Traeger (2014 EER)' 'Nordhaus (2015 AER)' 'Nordhaus (2019 AER)' 'Nordhaus (2013 YUP)' 'Nordhaus (2010 PNAS)' 'Rezai & Ploeg (2016 JAERE)' 'Rickels (2023 NCC)' 'Bremer & Ploeg (2021 AER)'};
d = {'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)' 'Deng (2024 EAP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Huai Deng'},{'Dawei Zhang'});
A = addedge(A,{'Hui Xu'},{'Dawei Zhang'});
A = addedge(A,{'Huan Wu'},{'Dawei Zhang'});

ID{490} = {'Laamouri & Khattabi (2025 Land)'};
H = addnode(H,{'Laamouri & Khattabi (2025 Land)'});
A = addedge(A,{'Anas Laamouri'},{'Abdellatif Khattabi'});

ID{491} = {'Xiao (2025 EST)'};
s = {'IAWGSCC (2021)' 'Rennert (2022 Nature)' 'Nordhaus (2018 CC)' 'Ricke (2018 NCC)'};
d = {'Xiao (2025 EST)' 'Xiao (2025 EST)' 'Xiao (2025 EST)' 'Xiao (2025 EST)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Song Xiao'},{'Yuting Yang'});
A = addedge(A,{'Song Xiao'},{'Yubei Li'});
A = addedge(A,{'Song Xiao'},{'Jingtong Lin'});
A = addedge(A,{'Song Xiao'},{'Yana Jin'});
A = addedge(A,{'Yuting Yang'},{'Yubei Li'});
A = addedge(A,{'Yuting Yang'},{'Jingtong Lin'});
A = addedge(A,{'Yuting Yang'},{'Yana Jin'});
A = addedge(A,{'Yubei Li'},{'Jingtong Lin'});
A = addedge(A,{'Yubei Li'},{'Yana Jin'});
A = addedge(A,{'Jingtong Lin'},{'Yana Jin'});

ID{492} = {'Schaumann & Asenjo (2025 PNAS)'};
s = {'Nordhaus (2014 JAERE)' 'Nordhaus (2017 PNAS)' 'Rennert (2022 Nature)' 'Cai (2015 PNAS)' 'Cai (2016 NCC)' 'Nordhaus (2019 PNAS)' 'EPA (2023)' 'Hansel (2020 NCC)' 'Howard & Sterner (2017 ERE)' 'Dietz & Stern (2015 EJ)'};
d = {'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)' 'Schaumann & Asenjo (2025 PNAS)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Felix Schaumann'},{'Eduardo A. de Asenjo'});

ID{493} = {'Ploeg (2025 JEEM)'};
s = {'Bremer & Ploeg (2021 AER)' 'Nordhaus (2008 YUP)' 'Rennert (2022 Nature)'}; 
d = {'Ploeg (2025 JEEM)' 'Ploeg (2025 JEEM)' 'Ploeg (2025 JEEM)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{494} = {'Ovaere & Proost (2025 ET)'};
s = {'Jaakkola & Ploeg (2019 JEEM)'}; 
d = {'Ovaere & Proost (2025 ET)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Martin Ovaere'},{'Stef Proost'});

ID{495} = {'Mohammadyari (2025 JES)'};
s = {'IAWGSCC (2021)'}; 
d = {'Mohammadyari (2025 JES)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Fatemeh Mohammadyari'},{'Ardavan Zarandian'});
A = addedge(A,{'Fatemeh Mohammadyari'},{'Majid R. Mehrian'});
A = addedge(A,{'Fatemeh Mohammadyari'},{'Roya Mousazadeh'});
A = addedge(A,{'Ardavan Zarandian'},{'Majid R. Mehrian'});
A = addedge(A,{'Ardavan Zarandian'},{'Roya Mousazadeh'});
A = addedge(A,{'Majid R. Mehrian'},{'Roya Mousazadeh'});

ID{496} = {'Raynaud (2014 UNEP)'};
s = {'Stern (2006 CUP)'}; 
d = {'Raynaud (2014 UNEP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addnode(A,{'Julie Raynaud'});

ID{497} = {'Costa (2025 ESPR)'};
s = {'Raynaud (2014 UNEP)'}; 
d = {'Costa (2025 ESPR)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Mariana V. da Costa'},{'Daniela Debone'});
A = addedge(A,{'Mariana V. da Costa'},{'Simone G.K. Miraglia'});
A = addedge(A,{'Daniela Debone'},{'Simone G.K. Miraglia'});
...
ID{499} = {'Cunanan (2025 IJHE)'};
s = {'Canada (2022)' 'Newell & Pizer (2004 EnP)'}; %Gillingham & Stock
d = {'Cunanan (2025 IJHE)' 'Cunanan (2025 IJHE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Carlo Cunanan'},{'Milind Jain'});
A = addedge(A,{'Carlo Cunanan'},{'Alain-Desire Nimubona'});
A = addedge(A,{'Carlo Cunanan'},{'Xiao-Yu Wu'});
A = addedge(A,{'Milind Jain'},{'Alain-Desire Nimubona'});
A = addedge(A,{'Milind Jain'},{'Xiao-Yu Wu'});
A = addedge(A,{'Alain-Desire Nimubona'},{'Xiao-Yu Wu'});

ID{500} = {'Cho (2025 AE)'};
s = {'EPA (2023)'};
d = {'Cho (2025 AE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Seong-Hoon Cho'},{'James C. Mingie'});
A = addedge(A,{'Seong-Hoon Cho'},{'Charles B. Sims'});
A = addedge(A,{'James C. Mingie'},{'Charles B. Sims'});

ID{501} = {'Caesary (2025 AEn)'};
s = {'IAWGSCC (2021)' 'Ricke (2018 NCC)' 'Downing (2005 ECI)' 'Rose (2017 CCE)' 'Caesary (2023 WEE)' 'Nordhaus & Sztorc (2013 Yale)'};
d = {'Caesary (2025 AEn)' 'Caesary (2025 AEn)' 'Caesary (2025 AEn)' 'Caesary (2025 AEn)' 'Caesary (2025 AEn)' 'Caesary (2025 AEn)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{502} = {'Fell (2025 JAERE)'};
H = addnode(H,{'Fell (2025 JAERE)'});
A = addedge(A,{'Harrison Fell'},{'Stephen P. Holland'});
A = addedge(A,{'Harrison Fell'},{'Andrew J. Yates'});
A = addedge(A,{'Stephen P. Holland'},{'Andrew J. Yates'});

ID{503} = {'Schaper (2025 FP)'};
s = {'UBA (2020)'};
d = {'Schaper (2025 FP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Julian Schaper'},{'Max Franks'});
A = addedge(A,{'Julian Schaper'},{'Nicholas Koch'});
A = addedge(A,{'Julian Schaper'},{'Charlotte Plinke'});
A = addedge(A,{'Julian Schaper'},{'Michael Sureth'});
A = addedge(A,{'Max Franks'},{'Nicholas Koch'});
A = addedge(A,{'Max Franks'},{'Charlotte Plinke'});
A = addedge(A,{'Max Franks'},{'Michael Sureth'});
A = addedge(A,{'Nicholas Koch'},{'Charlotte Plinke'});
A = addedge(A,{'Nicholas Koch'},{'Michael Sureth'});
A = addedge(A,{'Charlotte Plinke'},{'Michael Sureth'});

ID{504} = {'UBA (2024)'};
s = {'Prest (2024 Science)' 'Rennert (2022 Nature)' 'Anthoff (2007)' 'UBA (2019)'};
d = {'UBA (2024)' 'UBA (2024)' 'UBA (2024)' 'UBA (2024)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{505} = {'Kotchen (2025 REEP)'};
s = {'IAWGSCC (2021)'};
d = {'Kotchen (2025 REEP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{506} = {'Lubis (2025 JITKT)'};
s = {'Siagian (2024 JPSAL)' 'Rose (2017 CCE)'};
d = {'Lubis (2025 JITKT)' 'Lubis (2025 JITKT)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Khairul M. Lubis'},{'Zulhamsyah Imran'});
A = addedge(A,{'Khairul M. Lubis'},{'Taryono'});
A = addedge(A,{'Khairul M. Lubis'},{'Ario Damar'});
A = addedge(A,{'Zulhamsyah Imran'},{'Taryono'});
A = addedge(A,{'Zulhamsyah Imran'},{'Ario Damar'});
A = addedge(A,{'Taryono'},{'Ario Damar'});

ID{507} = {'Siagian (2024 JPSAL)'};
s = {'Rose (2017 CCE)'};
d = {'Siagian (2024 JPSAL)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Kristi Siagian'},{'Mahawan Karuniasa'});
A = addedge(A,{'Kristi Siagian'},{'Kosuke Mizuno'});
A = addedge(A,{'Mahawan Karuniasa'},{'Kosuke Mizuno'});

ID{508} = {'Chapin (2025 EST)'};
s = {'EPA (2023)'};
d = {'Chapin (2025 EST)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Fletcher T. Chapin'},{'Daly Wettermark'});
A = addedge(A,{'Fletcher T. Chapin'},{'Jose Bolorinos'});
A = addedge(A,{'Fletcher T. Chapin'},{'Meagan S. Mauter'});
A = addedge(A,{'Daly Wettermark'},{'Jose Bolorinos'});
A = addedge(A,{'Daly Wettermark'},{'Meagan S. Mauter'});
A = addedge(A,{'Jose Bolorinos'},{'Meagan S. Mauter'});

ID{509} = {'Kashanian (2025 EngE)'};
s = {'IAWGSCC (2021)' 'Rennert (2022 Nature)'};
d = {'Kashanian (2025 EngE)' 'Kashanian (2025 EngE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Motahareh Kashanian'},{'Shayan Tohidi'});
A = addedge(A,{'Motahareh Kashanian'},{'Sarah M. Ryan'});
A = addedge(A,{'Shayan Tohidi'},{'Sarah M. Ryan'});

ID{510} = {'Islam (2025 IEEEA)'};
s = {'IAWGSCC (2021)' 'Barrage & Nordhaus (2024 PNAS)' 'Ricke (2018 NCC)' 'Anthoff (2009 ERL)' 'Nordhaus (2014 JAERE)' 'Greenstone (2013 REEP)'};
d = {'Islam (2025 IEEEA)' 'Islam (2025 IEEEA)' 'Islam (2025 IEEEA)' 'Islam (2025 IEEEA)' 'Islam (2025 IEEEA)' 'Islam (2025 IEEEA)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Mohammad A. Islam'},{'M. Sajid Hasan'});
A = addedge(A,{'Mohammad A. Islam'},{'Imam-ur-Rashid'});
A = addedge(A,{'Mohammad A. Islam'},{'M. Manzurul Hasan'});
A = addedge(A,{'Mohammad A. Islam'},{'Jawadul A. Chowdhury'});
A = addedge(A,{'Mohammad A. Islam'},{'Moshiur R. Sohan'});
A = addedge(A,{'Mohammad A. Islam'},{'Nahid A. Jahan'});
A = addedge(A,{'Mohammad A. Islam'},{'M. Mofazzal Hossain'});
A = addedge(A,{'M. Sajid Hasan'},{'Imam-ur-Rashid'});
A = addedge(A,{'M. Sajid Hasan'},{'M. Manzurul Hasan'});
A = addedge(A,{'M. Sajid Hasan'},{'Jawadul A. Chowdhury'});
A = addedge(A,{'M. Sajid Hasan'},{'Moshiur R. Sohan'});
A = addedge(A,{'M. Sajid Hasan'},{'Nahid A. Jahan'});
A = addedge(A,{'M. Sajid Hasan'},{'M. Mofazzal Hossain'});
A = addedge(A,{'Imam-ur-Rashid'},{'M. Manzurul Hasan'});
A = addedge(A,{'Imam-ur-Rashid'},{'Jawadul A. Chowdhury'});
A = addedge(A,{'Imam-ur-Rashid'},{'Moshiur R. Sohan'});
A = addedge(A,{'Imam-ur-Rashid'},{'Nahid A. Jahan'});
A = addedge(A,{'Imam-ur-Rashid'},{'M. Mofazzal Hossain'});
A = addedge(A,{'M. Manzurul Hasan'},{'Jawadul A. Chowdhury'});
A = addedge(A,{'M. Manzurul Hasan'},{'Moshiur R. Sohan'});
A = addedge(A,{'M. Manzurul Hasan'},{'Nahid A. Jahan'});
A = addedge(A,{'M. Manzurul Hasan'},{'M. Mofazzal Hossain'});
A = addedge(A,{'Jawadul A. Chowdhury'},{'Moshiur R. Sohan'});
A = addedge(A,{'Jawadul A. Chowdhury'},{'Nahid A. Jahan'});
A = addedge(A,{'Jawadul A. Chowdhury'},{'M. Mofazzal Hossain'});
A = addedge(A,{'Moshiur R. Sohan'},{'Nahid A. Jahan'});
A = addedge(A,{'Moshiur R. Sohan'},{'M. Mofazzal Hossain'});
A = addedge(A,{'Nahid A. Jahan'},{'M. Mofazzal Hossain'});

ID{511} = {'Serfas (2025 AJARE)'};
s = {'IAWGSCC (2021)' 'Rennert (2022 Nature)'}; 
d = {'Serfas (2025 AJARE)' 'Serfas (2025 AJARE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addnode(A,'Devin A. Serfas');

ID{512} = {'Springmann (2025 LPH)'};
s = {'Rennert (2022 Nature)'}; 
d = {'Springmann (2025 LPH)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Marco Springmann'},{'Manasi P. Hansoge'});
A = addedge(A,{'Marco Springmann'},{'Linda Schultz'});
A = addedge(A,{'Marco Springmann'},{'Silvia Pastorino'});
A = addedge(A,{'Marco Springmann'},{'Donald A.P. Bundy'});
A = addedge(A,{'Manasi P. Hansoge'},{'Linda Schultz'});
A = addedge(A,{'Manasi P. Hansoge'},{'Silvia Pastorino'});
A = addedge(A,{'Manasi P. Hansoge'},{'Donald A.P. Bundy'});
A = addedge(A,{'Linda Schultz'},{'Silvia Pastorino'});
A = addedge(A,{'Linda Schultz'},{'Donald A.P. Bundy'});
A = addedge(A,{'Silvia Pastorino'},{'Donald A.P. Bundy'});
...
ID{514} = {'Rose (2022 ElJ)'};
s = {'GAO (2020)'}; 
d = {'Rose (2022 ElJ)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Adam Rose'},{'Dan Wei'});
A = addedge(A,{'Adam Rose'},{'Adam Einbinder'});
A = addedge(A,{'Adam Einbinder'},{'Dan Wei'});

ID{515} = {'Rose (2025 Energies)'};
s = {'Rose (2022 ElJ)' 'EPA (2023)'}; 
d = {'Rose (2025 Energies)' 'Rose (2025 Energies)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Adam Rose'},{'Nathaniel Gundersen'});
A = addedge(A,{'Adam Rose'},{'Yamini Kumar'});
A = addedge(A,{'Adam Rose'},{'Joshua Jacobs'});
A = addedge(A,{'Adam Rose'},{'Isabel Reynoso'});
A = addedge(A,{'Adam Rose'},{'Najmedin Meshkati'});
A = addedge(A,{'Nathaniel Gundersen'},{'Yamini Kumar'});
A = addedge(A,{'Nathaniel Gundersen'},{'Joshua Jacobs'});
A = addedge(A,{'Nathaniel Gundersen'},{'Isabel Reynoso'});
A = addedge(A,{'Nathaniel Gundersen'},{'Najmedin Meshkati'});
A = addedge(A,{'Yamini Kumar'},{'Joshua Jacobs'});
A = addedge(A,{'Yamini Kumar'},{'Isabel Reynoso'});
A = addedge(A,{'Yamini Kumar'},{'Najmedin Meshkati'});
A = addedge(A,{'Joshua Jacobs'},{'Isabel Reynoso'});
A = addedge(A,{'Joshua Jacobs'},{'Najmedin Meshkati'});
A = addedge(A,{'Isabel Reynoso'},{'Najmedin Meshkati'});

ID{516} = {'Wang (2025 EER)'};
s = {'Barrage (2018 JPubE)' 'Barrage (2020 REStud)' 'Barrage & Nordhaus (2024 PNAS)' 'Bijgaart (2016 JEEM)' 'Dietz & Stern (2015 EJ)' 'Drupp & Hansel (2021 AEJ)' 'Gerlagh (2023 EER)' 'Golosov (2014 Ectra)' 'Nordhaus (1992 Science)' 'Nordhaus (2017 PNAS)' 'Wang (2024 DA)'};
d = {'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)' 'Wang (2025 EER)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{517} = {'Howard & Sylvan (2015a IPI)'};
s = {'Howard & Sterner (2017 ERE)' 'Schauer (1995 ERE)'};
d = {'Howard & Sylvan (2015a IPI)' 'Howard & Sylvan (2015a IPI)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{518} = {'Howard & Sylvan (2015b IPI)'};
s = {'Howard & Sterner (2017 ERE)' 'Schauer (1995 ERE)' 'Howard & Sylvan (2015a IPI)'};
d = {'Howard & Sylvan (2015b IPI)' 'Howard & Sylvan (2015b IPI)' 'Howard & Sylvan (2015a IPI)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{519} = {'Sylvan (2017 IPI)'};
s = {'Howard & Sylvan (2015b IPI)' 'IAWGSCC (2010)' 'IAWGSCC (2015)' 'Nordhaus (2017 PNAS)' 'Marten (2015 CP)'};
d = {'Sylvan (2017 IPI)' 'Sylvan (2017 IPI)' 'Sylvan (2017 IPI)' 'Sylvan (2017 IPI)' 'Sylvan (2017 IPI)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);

ID{520} = {'EDF (2017)'};
s = {'Sylvan (2017 IPI)' 'Shelanski and Obstfeld (2015)'};
d = {'EDF (2017)' 'EDF (2017)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addnode(A,'EDF');

ID{521} = {'Manan (2025 Bio)'};
s = {'EDF (2017)'};
d = {'Manan (2025 Bio)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Abdul Manan'},{'La B. Sudia'});
A = addedge(A,{'Abdul Manan'},{'Umar O. Hasani'});
A = addedge(A,{'Abdul Manan'},{'Surya C.R. Kete'});
A = addedge(A,{'Abdul Manan'},{'La Gandri'});
A = addedge(A,{'Abdul Manan'},{'Asramid Yasin'});
A = addedge(A,{'Abdul Manan'},{'Agusrinal'});
A = addedge(A,{'Abdul Manan'},{'Isabela'});
A = addedge(A,{'La B. Sudia'},{'Umar O. Hasani'});
A = addedge(A,{'La B. Sudia'},{'Surya C.R. Kete'});
A = addedge(A,{'La B. Sudia'},{'La Gandri'});
A = addedge(A,{'La B. Sudia'},{'Asramid Yasin'});
A = addedge(A,{'La B. Sudia'},{'Agusrinal'});
A = addedge(A,{'La B. Sudia'},{'Isabela'});
A = addedge(A,{'Umar O. Hasani'},{'Surya C.R. Kete'});
A = addedge(A,{'Umar O. Hasani'},{'La Gandri'});
A = addedge(A,{'Umar O. Hasani'},{'Asramid Yasin'});
A = addedge(A,{'Umar O. Hasani'},{'Agusrinal'});
A = addedge(A,{'Umar O. Hasani'},{'Isabela'});
A = addedge(A,{'Surya C.R. Kete'},{'La Gandri'});
A = addedge(A,{'Surya C.R. Kete'},{'Asramid Yasin'});
A = addedge(A,{'Surya C.R. Kete'},{'Agusrinal'});
A = addedge(A,{'Surya C.R. Kete'},{'Isabela'});
A = addedge(A,{'La Gandri'},{'Asramid Yasin'});
A = addedge(A,{'La Gandri'},{'Agusrinal'});
A = addedge(A,{'La Gandri'},{'Isabela'});
A = addedge(A,{'Asramid Yasin'},{'Agusrinal'});
A = addedge(A,{'Asramid Yasin'},{'Isabela'});
A = addedge(A,{'Agusrinal'},{'Isabela'});

ID{522} = {'Shelanski and Obstfeld (2015)'};
s = {'IAWGSCC (2015)'}; 
d = {'Shelanski and Obstfeld (2015)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Howard Shelanski'},{'Maurice Obstfeld'});

ID{523} = {'Neal (2025 ERL)'};
s = {'Stern (2006 CUP)' 'Barrage & Nordhaus (2024 PNAS)' 'Bilal & Kanzig (2024 NBER)'};
d = {'Neal (2025 ERL)' 'Neal (2025 ERL)' 'Neal (2025 ERL)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Timothy Neal'},{'Ben R. Newell'});
A = addedge(A,{'Timothy Neal'},{'Andy Pitman'});
A = addedge(A,{'Andy Pitman'},{'Ben R. Newell'});

ID{524} = {'Coppens (2025 JEEM)'};
s = {'Dietz (2021 JAERE)' 'Dietz & Venmans (2019 JEEM)' 'Gillingham (2018 JAERE)' 'Golosov (2014 Ectra)' 'Goulder & Mathai (2000 JEEM)' 'Nordhaus (2017 PNAS)' 'Olijslagers (2023 JEDC)' 'Popp (2004 JEEM)' 'Rezai & Ploeg (2016 JAERE)' 'Rezai & Ploeg (2017 ERE)' 'Traeger (2023 AEJ)' 'Bijgaart (2016 JEEM)'};
d = {'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)' 'Coppens (2025 JEEM)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Leo Coppens'},{'Simon Dietz'});
A = addedge(A,{'Frank Venmans'},{'Leo Coppens'});

ID{525} = {'Bilal & Kanzig (2024 NBER)'};
s = {'Dietz (2021 JAERE)' 'Nordhaus (2013 Els)' 'Nordhaus (1992 Science)' 'Rennert (2022 Nature)' 'Stern (2006 CUP)' 'Folini (2025 REStud)'};
d = {'Bilal & Kanzig (2024 NBER)' 'Bilal & Kanzig (2024 NBER)' 'Bilal & Kanzig (2024 NBER)' 'Bilal & Kanzig (2024 NBER)' 'Bilal & Kanzig (2024 NBER)' 'Bilal & Kanzig (2024 NBER)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Adrien Bilal'},{'Diego R. Kanzig'});

ID{526} = {'Folini (2025 REStud)'};
s = {'Barrage (2018 JPubE)' 'Bauer & Rudebusch (2023 REStat)' 'Botzen & Bergh (2012 EL)' 'Cai & Lontzek (2019 JPE)' 'Dietz (2021 JAERE)' 'Golosov (2014 Ectra)' 'Hambel (2021 EER)' 'Hansel & Quaas (2018 EcE)' 'Hope (2013 CC)' 'Howard & Sterner (2017 ERE)' 'Hwang (2017 REE)' 'Kotlikoff (2021 IER)' 'Lontzek (2015 NCC)' 'Nordhaus (2008 YUP)' 'Nordhaus (2013 Els)' 'Nordhaus (2018 CC)' 'Nordhaus (2018 AEJ)' 'Popp (2004 JEEM)' 'Stern (2006 CUP)' 'Traeger (2014 ERE)' 'Nordhaus (2011 NBER)' 'Traeger (2023 AEJ)'};
d = {'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)' 'Folini (2025 REStud)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Doris Folini'},{'Aleksandra Friedl'});
A = addedge(A,{'Doris Folini'},{'Felix Kubler'});
A = addedge(A,{'Doris Folini'},{'Simon Scheidegger'});
A = addedge(A,{'Aleksandra Friedl'},{'Felix Kubler'});
A = addedge(A,{'Aleksandra Friedl'},{'Simon Scheidegger'});

ID{527} = {'Meng (2025 JMathE)'};
s = {'Ackerman (2013 ERE)' 'Bauer & Rudebusch (2023 REStat)' 'Cai & Lontzek (2019 JPE)' 'Crost & Traeger (2014 NCC)' 'Daniel (2019 PNAS)' 'Golosov (2014 Ectra)' 'Hambel (2021 EER)' 'Hong (2023 Ectra)' 'Jensen & Traeger (2014 EER)' 'Lemoine (2021 JAERE)' 'Nordhaus (1991 EJ)' 'Nordhaus (2008 YUP)' 'Nordhaus (2017 PNAS)' 'Okullo (2020 ERE)' 'Olijslagers (2023 JEDC)' 'Stern (2006 CUP)' 'Traeger (2023 AEJ)'};
d = {'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)' 'Meng (2025 JMathE)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
A = addedge(A,{'Weizhen Meng'},{'Tuyue Chen'});
A = addedge(A,{'Tuyue Chen'},{'Jinqiang Yang'});

ID{528} = {'Mendelsohn (2004 CUP)'};
s = {'Cline (2004 CUP)' 'Nordhaus (1991 EJ)' 'Nordhaus & Boyer (2000 MIT)' 'Pearce (2003 OxREP)'}; 
d = {'Mendelsohn (2004 CUP)' 'Mendelsohn (2004 CUP)' 'Mendelsohn (2004 CUP)' 'Mendelsohn (2004 CUP)'};
weights = ones(1,size(s,2))/size(s,2); H = addedge(H,s,d,weights);
